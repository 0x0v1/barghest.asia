...
description: "How contacts and call history leave a seized phone over Bluetooth PBAP: a Russian border seizure forensicated using MESH, next to the identifier collection relevant to SORM."
